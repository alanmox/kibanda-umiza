...
-- Migrate existing admin into users table (password: admin123)
INSERT INTO users (username, email, password_hash, role) VALUES
('admin', 'admin@kibandaumiza.co.tz', '$2y$12$HxHHso6myFsvs/P1juQBhOM8TE7pvh1wCkvR78pYvtjHidAfsOOMq', 'admin');
